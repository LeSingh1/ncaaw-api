...
Small, unofficial Node client for ESPN's women's college basketball data. ESPN serves women's college basketball
under `basketball/womens-college-basketball`, and this wraps those endpoints.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
repo is one client for every sport. This one is just women's college basketball, in the style of
...
cd ncaaw-api
node examples/scoreboard.js   # women's college basketball games on the board
